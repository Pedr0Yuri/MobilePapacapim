...
class PostDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListenableBuilder(
      listenable: PostsStore.instance,
      builder: (context, _) {
        final store = PostsStore.instance;
        final post = store.findPost(postId);
                ...
                children: [
                                ...
                                child: Builder(
                                  builder: (context) {
                                    ...
                                    return CircleAvatar(
                                      ...
                                      backgroundImage: img,
                                      child: img == null
                                          ? Icon(Icons.person, color: AppColors.secondary.withValues(alpha: 0.5), size: 28)
                                          : null,
                                    );
                                  }
                                ),
                                        ...
                                        showDialog(
                                          ...
                                          builder: (ctx) => AlertDialog(
                                            ...
                                            actions: [
                                              ...
                                              TextButton(onPressed: () { store.deletePost(post['id']); Navigator.pop(ctx); Navigator.pop(context); }, child: const Text('Excluir', style: TextStyle(color: AppColors.danger))),
                                            ],
                                          ),
                                        );
                                      }
                  ...
                  Container(
                    ...
                    child: GestureDetector(
                      onTap: () => showPostReplySheet(context, post['id']),
                      child: Container(
