                                    ...
                                    showDialog(
                                      ...
                                      builder: (ctx) => AlertDialog(
                                        ...
                                        actions: [
                                          ...
                                          TextButton(onPressed: () { _store.deletePost(post['id']); Navigator.pop(ctx); Navigator.pop(context); }, child: const Text('Excluir', style: TextStyle(color: AppColors.danger))),
                                        ],
                                      ),
                                    );
                                  }
